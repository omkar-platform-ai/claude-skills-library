...
└── references/
    ├── indian-mutual-funds.md      ← SEBI categories, rolling returns, AMC quality
    ├── us-etfs-funds.md            ← ETF mechanics, expense benchmarks, PFIC rules
    ├── direct-equity-india.md      ← Fundamental analysis, sector metrics, governance
    ├── direct-equity-us.md         ← US GAAP metrics, moat analysis, ROIC framework
    ├── debt-bonds.md               ← Duration matching, credit ratings, rate cycle
